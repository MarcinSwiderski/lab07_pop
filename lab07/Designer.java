...
public class Designer implements IDesigner, ListModel<String> {
    ...
    private JButton editStandButton;
    ...
    private Map<IStand, String> standTitle = new HashMap<>();
    private ICenter ic;
    private int id;
    ...
    private void startGUI() {
        ...
        questionsAnswersTable.setModel(new DefaultTableModel(new Object[]{"Questions", "Answers"}, 0) {
            public boolean isCellEditable(int row, int column) {
                return false;
            }
        });
        standsList.setModel(this);
        editStandButton.addActionListener(actionEvent -> editStandText());
    ...
    private void editStandText() {
        ...
        String oldText = standTitle.getOrDefault(stand, "");
        String newText = JOptionPane.showInputDialog(panel, "Enter new question:", oldText);

        standTitle.put(stand, newText);
    ...
    private void notifyStandListListeners() {
        ListDataEvent listDataEvent = new ListDataEvent(this, ListDataEvent.CONTENTS_CHANGED, 0, stands.size() - 1);
        standsListDataListener.forEach(listDataListener -> listDataListener.contentsChanged(listDataEvent));
    }
    ...
    public String getElementAt(int i) {
        ...
        return standTitle.getOrDefault(stand, "------------");
    }
